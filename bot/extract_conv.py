...
# 用于将原始语料库进行转换生成train.pkl和train_input.pkl
def main(fileName, limit=20, x_limit=3, y_limit=6):
    print('extract lines')
    ...
    pickle.dump(ws_input, open('train_input.pkl', 'wb'))

    print('done')


if __name__ == '__main__':
    main("dgk_shooter_min.conv")

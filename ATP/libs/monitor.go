...
func SystemInfo(startTime int64) map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"当前 Heap 内存使用量": FileSize(int64(mstat.HeapAlloc)),
		"Heap 内存占用量":    FileSize(int64(mstat.HeapSys)),
		"Heap 内存空闲量":    FileSize(int64(mstat.HeapIdle)),
		"正在使用的 Heap 内存": FileSize(int64(mstat.HeapInuse)),
		"被释放的 Heap 内存":  FileSize(int64(mstat.HeapReleased)),

...
import com.snake.genrater.service.FakeValuesService;
...
public class Genrater {
    ...
    public Genrater(Locale locale) {
        this(locale, null);
    }

    public Genrater(Random random) {
        this(Locale.ENGLISH, random);
    }

    public Genrater(Locale locale, Random random) {
    ...
    /**
     * Constructs Genrater instance with default argument.
     *
     * @return {@link Genrater#Genrater()}
     */
    public static Genrater instance() {
        return new Genrater();
    }

    /**
     * Constructs Genrater instance with provided {@link Locale}.
     *
     * @param locale - {@link Locale}
     * @return {@link Genrater#Genrater(Locale)}
     */
    public static Genrater instance(Locale locale) {
        return new Genrater(locale);
    }

    /**
     * Constructs Genrater instance with provided {@link Random}.
     *
     * @param random - {@link Random}
     * @return {@link Genrater#Genrater(Random)}
     */
    public static Genrater instance(Random random) {
        return new Genrater(random);
    }

    /**
     * Constructs Genrater instance with provided {@link Locale} and {@link Random}.
     *
     * @param locale - {@link Locale}
     * @param random - {@link Random}
     * @return {@link Genrater#Genrater(Locale, Random)}
     */
    public static Genrater instance(Locale locale, Random random) {
        return new Genrater(locale, random);
    }

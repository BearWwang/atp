...
public class Weather {
    ...
    protected Weather(Genrater genrater) {
    ...
    public String description() {
        return genrater.resolve("weather.description");
    }
    ...
    private String temperature(int minTemperature, int maxTemperature, String degreeKey) {
        return genrater.random().nextInt(minTemperature, maxTemperature) + genrater.resolve(degreeKey);
    }
}

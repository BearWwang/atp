package com.snake.genrater.idnumbers;
...
public class SvSEIdNumber {
    ...
    public String getValidSsn(Genrater f) {
        String candidate = "";
    ...
    public String getInvalidSsn(Genrater f) {
    ...
    private String getPattern(Genrater genrater) {
        return validPatterns[genrater.random().nextInt(2)];
    }
